...
def get_population_counts(christian_names_set, data_file):
    """ Calculate the total population of Christian names for each state found in the data file. """
    state_counts = {}
    with open(data_file, 'r') as file:
        ...
        for line in file:
            ...
            if name in christian_names_set:
...
def save_results_to_csv(results, output_file):
    ...
    with open(output_file, 'w') as file:
        file.write('State,Total Christian Name Count\n')
...
output_csv_file = '1910_state_christian_name_counts.csv'
